...
<body>
	<div class="container">
		<form data-status='正在登录...' data-url="/survey/admin/right/list" class="form-signin" role="form" name="login" action="j_spring_security_check" method="post">
			...
			<div class="form-group input-group-lg">
				...
				<input type="text" name="verifycode" style=" display: inline;width: 44%;  float: left;" placeholder="输入验证码" id="verifycode" class="form-control"> <img
					alt="点击我刷新验证码"style="cursor: pointer; margin-left:2%" src="/survey/verify" class="fl">
			</div>
			<div class="form-group input-group-lg">
